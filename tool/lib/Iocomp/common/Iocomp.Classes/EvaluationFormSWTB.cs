...
namespace Iocomp.Classes
{
	public class EvaluationFormSWTB : Form
	{
		...
		private void InitializeComponent()
		{
			...
			label2.TabIndex = 1;
			label2.Text = "Copyright © 1998-2007 Iocomp Software Inc.";
			...
			HomeLinkLabel.Size = new Size(128, 16);
			HomeLinkLabel.TabIndex = 3;
			HomeLinkLabel.TabStop = true;
			HomeLinkLabel.Text = " instrumentationopc.com";
			...
			label1.TabIndex = 8;
			label1.Text = "Warning: This computer program is protected by copright law and international treaties. Unauthorized reproduction or distribution of this program, or any portion of it, may result in severe civil and criminal penalties, and will be prosecuted to the maximum extent possible under law.\r\n";
			...
			SupportLinkLabel.Size = new Size(149, 16);
			SupportLinkLabel.TabIndex = 12;
			SupportLinkLabel.TabStop = true;
			SupportLinkLabel.Text = "support.softwaretoolbox.com";
			SupportLinkLabel.LinkClicked += SupportLinkLabel_LinkClicked;
			label6.AutoSize = true;
			label6.Location = new Point(224, 56);
			label6.Name = "label6";
			...
			SalesLinkLabel.Size = new Size(169, 16);
			SalesLinkLabel.TabIndex = 14;
			SalesLinkLabel.TabStop = true;
			SalesLinkLabel.Text = "instrumentationopc.com/ordering";
			SalesLinkLabel.LinkClicked += SalesLinkLabel_LinkClicked;
