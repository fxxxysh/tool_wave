...
namespace Iocomp.Design
{
	...
	public class AnnotationRectangleEditorPlugIn : PlugInStandard
	{
		...
		private void InitializeComponent()
		{
			...
			HeightTextBox.Location = new Point(48, 120);
			...
			WidthTextBox.Location = new Point(48, 96);
			...
			XTextBox.Location = new Point(48, 48);
			...
			YTextBox.Location = new Point(48, 72);
			...
			label9.Location = new Point(33, 74);
			label9.Name = "label9";
			...
			RotationTextBox.Location = new Point(48, 144);
			...
			focusLabel1.Location = new Point(-1, 146);
