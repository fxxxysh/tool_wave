...
namespace Iocomp.Design
{
	...
	[ToolboxItem(false)]
	public class AnnotationPieEditorPlugIn : PlugInStandard
	{
		...
		public AnnotationPieEditorPlugIn()
		{
			InitializeComponent();
		}
		...
		private void InitializeComponent()
		{
			...
			CanSizeCheckBox.Location = new Point(360, 8);
			...
			label7.Location = new Point(44, 98);
			label7.Name = "label7";
			label7.Size = new Size(36, 15);
			label7.Text = "Width";
			label7.LoadingEnd();
			WidthTextBox.LoadingBegin();
			WidthTextBox.Location = new Point(80, 96);
			...
			XTextBox.Location = new Point(80, 48);
			...
			label8.Location = new Point(65, 50);
			label8.Name = "label8";
			label8.Size = new Size(15, 15);
			label8.Text = "X";
			label8.LoadingEnd();
			YTextBox.LoadingBegin();
			YTextBox.Location = new Point(80, 72);
			...
			label9.Location = new Point(65, 74);
			label9.Name = "label9";
			label9.Size = new Size(15, 15);
			label9.Text = "Y";
			label9.LoadingEnd();
			EnabledCheckBox.Location = new Point(168, 8);
			...
			VisibleCheckBox.Location = new Point(80, 8);
			...
			RotationTextBox.Location = new Point(80, 144);
			...
			focusLabel1.Location = new Point(31, 146);
			...
			groupBox1.Location = new Point(144, 138);
			...
			groupBox2.Location = new Point(144, 42);
			...
			groupBox3.Location = new Point(376, 138);
			...
			groupBox4.Location = new Point(376, 42);
			...
			SweepAngleTextBox.Location = new Point(80, 192);
			...
			focusLabel10.FocusControl = SweepAngleTextBox;
			focusLabel10.Location = new Point(8, 194);
			focusLabel10.Name = "focusLabel10";
			focusLabel10.Size = new Size(72, 15);
			focusLabel10.Text = "Sweep Angle";
			focusLabel10.LoadingEnd();
			StartAngleTextBox.LoadingBegin();
			StartAngleTextBox.Location = new Point(80, 168);
			...
			focusLabel11.FocusControl = StartAngleTextBox;
			focusLabel11.Location = new Point(18, 170);
			focusLabel11.Name = "focusLabel11";
			focusLabel11.Size = new Size(62, 15);
			focusLabel11.Text = "Start Angle";
			...
			base.Name = "AnnotationPieEditorPlugIn";
