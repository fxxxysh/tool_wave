...
namespace Iocomp.Design
{
	...
	public class AnnotationPolygonEditorPlugIn : PlugInStandard
	{
		...
		public AnnotationPolygonEditorPlugIn()
		{
			InitializeComponent();
		}
		...
		private void InitializeComponent()
		{
			...
			base.SuspendLayout();
			CanMoveCheckBox.Location = new Point(232, 8);
			...
			CanSizeCheckBox.Location = new Point(328, 8);
			...
			EnabledCheckBox.Location = new Point(136, 8);
			...
			VisibleCheckBox.Location = new Point(48, 8);
			...
			groupBox1.Location = new Point(112, 139);
			...
			groupBox2.Location = new Point(112, 43);
			...
			groupBox3.Location = new Point(344, 139);
			...
			groupBox4.Location = new Point(344, 43);
			...
			base.Name = "AnnotationPolygonEditorPlugIn";
		...
		{
			base.SubPlugIns[0].Value = (base.Value as AnnotationPolygon).Points;
		}
	}
}
