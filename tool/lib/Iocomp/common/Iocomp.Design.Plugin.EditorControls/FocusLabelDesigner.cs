...
namespace Iocomp.Design.Plugin.EditorControls
{
	public class FocusLabelDesigner : ControlDesigner
	{
		public override DesignerVerbCollection Verbs
		{
			get
			{
				DesignerVerb[] value = new DesignerVerb[5]
				{
					...
					new DesignerVerb("Text = FocusControl-PropertyName", OnSetTextFocusControlPropertyName)
				};
		...
		protected override void OnContextMenu(int x, int y)
		{
			...
			Verbs[0].Enabled = (focusLabel.FocusControl != null);
			Verbs[1].Enabled = (focusLabel.FocusControl != null);
			Verbs[2].Enabled = (focusLabel.FocusControl != null);
			Verbs[3].Enabled = (focusLabel.FocusControl != null);
			Verbs[4].Enabled = (focusLabel.FocusControl != null);
