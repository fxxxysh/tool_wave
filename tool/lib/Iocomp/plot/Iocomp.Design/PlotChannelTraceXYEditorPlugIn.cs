...
namespace Iocomp.Design
{
	...
	public class PlotChannelTraceXYEditorPlugIn : PlugInStandard
	{
		...
		private void InitializeComponent()
		{
			...
			base.Name = "PlotChannelTraceXYEditorPlugIn";
		...
		{
			base.AddSubPlugIn(new PlotChannelTraceXYDataPointsEditorPlugIn(), "Data-Points", false);
