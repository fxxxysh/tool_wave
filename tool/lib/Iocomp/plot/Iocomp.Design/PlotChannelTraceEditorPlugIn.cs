...
namespace Iocomp.Design
{
	...
	public class PlotChannelTraceEditorPlugIn : PlugInStandard
	{
		...
		private Iocomp.Design.Plugin.EditorControls.CheckBox DrawAntiAliasCheckBox;
		...
		private void InitializeComponent()
		{
			...
			DrawAntiAliasCheckBox = new Iocomp.Design.Plugin.EditorControls.CheckBox();
			...
			DrawAntiAliasCheckBox.Location = new Point(520, 3);
			DrawAntiAliasCheckBox.Name = "DrawAntiAliasCheckBox";
			DrawAntiAliasCheckBox.PropertyName = "DrawAntiAlias";
			DrawAntiAliasCheckBox.TabIndex = 44;
			DrawAntiAliasCheckBox.Text = "Draw Anti-Alias";
			base.Controls.Add(DrawAntiAliasCheckBox);
			...
			base.Name = "PlotChannelTraceEditorPlugIn";
		...
		{
			base.AddSubPlugIn(new PlotChannelTraceDataPointsEditorPlugIn(), "Data-Points", false);
