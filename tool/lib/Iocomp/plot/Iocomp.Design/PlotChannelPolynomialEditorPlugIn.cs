...
namespace Iocomp.Design
{
	...
	public class PlotChannelPolynomialEditorPlugIn : PlugInStandard
	{
		...
		public PlotChannelPolynomialEditorPlugIn()
		{
			InitializeComponent();
		}
		...
		private void InitializeComponent()
		{
			...
			base.Name = "PlotChannelPolynomialEditorPlugIn";
		...
		{
			base.AddSubPlugIn(new PlotChannelPolynomialDataPointsEditorPlugIn(), "Data-Points", false);
		...
		public override void SetSubPlugInsValue()
		{
			...
			base.SubPlugIns[1].Value = (base.Value as PlotChannelPolynomial).Trace;
			base.SubPlugIns[2].Value = (base.Value as PlotChannelPolynomial).Fill;
			base.SubPlugIns[3].Value = (base.Value as PlotChannelPolynomial).Markers;
		}
	}
}
