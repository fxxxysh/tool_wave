...
namespace Iocomp.Design
{
	...
	public class PlotDataCursorXYEditorPlugIn : PlugInStandard
	{
		...
		private void InitializeComponent()
		{
			...
			ContextMenuEnabledCheckBox.TabIndex = 10;
			...
			UserCanEditCheckBox.TabIndex = 11;
