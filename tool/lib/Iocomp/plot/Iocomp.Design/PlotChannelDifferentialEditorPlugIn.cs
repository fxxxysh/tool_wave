...
namespace Iocomp.Design
{
	...
	public class PlotChannelDifferentialEditorPlugIn : PlugInStandard
	{
		...
		private void InitializeComponent()
		{
			...
			base.Name = "PlotChannelDifferentialEditorPlugIn";
			base.Size = new Size(584, 296);
		...
		{
			base.AddSubPlugIn(new PlotChannelDifferentialDataPointsEditorPlugIn(), "Data-Points", false);
			base.AddSubPlugIn(new PlotChannelDifferentialSpecificEditorPlugIn(), "Differential", false);
