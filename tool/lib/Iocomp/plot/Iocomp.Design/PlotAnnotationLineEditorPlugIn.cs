...
namespace Iocomp.Design
{
	...
	public class PlotAnnotationLineEditorPlugIn : PlugInStandard
	{
		...
		private void InitializeComponent()
		{
			...
			Point1XEditBox = new EditBox();
			Point1YEditBox = new EditBox();
			focusLabel2 = new FocusLabel();
			Point2GroupBox = new GroupBox();
			focusLabel4 = new FocusLabel();
			Point2XEditBox = new EditBox();
			Point2YEditBox = new EditBox();
			...
			Point1GroupBox.Controls.Add(focusLabel3);
			Point1GroupBox.Controls.Add(Point1YEditBox);
			Point1GroupBox.Controls.Add(focusLabel2);
			Point1GroupBox.Controls.Add(Point1XEditBox);
			Point1GroupBox.Location = new Point(144, 168);
			Point1GroupBox.Name = "Point1GroupBox";
			Point1GroupBox.Size = new Size(200, 56);
			Point1GroupBox.TabIndex = 17;
			Point1GroupBox.TabStop = false;
			Point1GroupBox.Text = "Point-1";
			focusLabel3.LoadingBegin();
			focusLabel3.FocusControl = Point1XEditBox;
			focusLabel3.Location = new Point(9, 26);
			focusLabel3.Name = "focusLabel3";
			focusLabel3.Size = new Size(15, 15);
			focusLabel3.Text = "X";
			focusLabel3.LoadingEnd();
			Point1XEditBox.LoadingBegin();
			Point1XEditBox.Location = new Point(24, 24);
			Point1XEditBox.Name = "Point1XEditBox";
			Point1XEditBox.PropertyName = "Point1X";
			Point1XEditBox.Size = new Size(72, 20);
			Point1XEditBox.TabIndex = 0;
			Point1XEditBox.LoadingEnd();
			Point1YEditBox.LoadingBegin();
			Point1YEditBox.Location = new Point(120, 24);
			Point1YEditBox.Name = "Point1YEditBox";
			Point1YEditBox.PropertyName = "Point1Y";
			Point1YEditBox.Size = new Size(72, 20);
			Point1YEditBox.TabIndex = 1;
			Point1YEditBox.LoadingEnd();
			focusLabel2.LoadingBegin();
			focusLabel2.FocusControl = Point1YEditBox;
			focusLabel2.Location = new Point(105, 26);
			focusLabel2.Name = "focusLabel2";
			focusLabel2.Size = new Size(15, 15);
			focusLabel2.Text = "Y";
			focusLabel2.LoadingEnd();
			Point2GroupBox.Controls.Add(focusLabel4);
			Point2GroupBox.Controls.Add(Point2YEditBox);
			Point2GroupBox.Controls.Add(focusLabel5);
			Point2GroupBox.Controls.Add(Point2XEditBox);
			Point2GroupBox.Location = new Point(352, 168);
			Point2GroupBox.Name = "Point2GroupBox";
			Point2GroupBox.Size = new Size(200, 56);
			Point2GroupBox.TabIndex = 18;
			Point2GroupBox.TabStop = false;
			Point2GroupBox.Text = "Point-2";
			focusLabel4.LoadingBegin();
			focusLabel4.FocusControl = Point2XEditBox;
			focusLabel4.Location = new Point(9, 26);
			focusLabel4.Name = "focusLabel4";
			focusLabel4.Size = new Size(15, 15);
			focusLabel4.Text = "X";
			focusLabel4.LoadingEnd();
			Point2XEditBox.LoadingBegin();
			Point2XEditBox.Location = new Point(24, 24);
			Point2XEditBox.Name = "Point2XEditBox";
			Point2XEditBox.PropertyName = "Point2X";
			Point2XEditBox.Size = new Size(72, 20);
			Point2XEditBox.TabIndex = 0;
			Point2XEditBox.LoadingEnd();
			Point2YEditBox.LoadingBegin();
			Point2YEditBox.Location = new Point(120, 24);
			Point2YEditBox.Name = "Point2YEditBox";
			Point2YEditBox.PropertyName = "Point2Y";
			Point2YEditBox.Size = new Size(72, 20);
			Point2YEditBox.TabIndex = 1;
			Point2YEditBox.LoadingEnd();
			focusLabel5.LoadingBegin();
			focusLabel5.FocusControl = Point2YEditBox;
			focusLabel5.Location = new Point(105, 26);
			...
			focusLabel1.FocusControl = YAxisNameTextBox;
			focusLabel1.Location = new Point(160, 66);
			focusLabel1.Name = "focusLabel1";
			focusLabel1.Size = new Size(72, 15);
			focusLabel1.Text = "Y-Axis Name";
			...
			focusLabel8.FocusControl = LayerNumericUpDown;
			focusLabel8.Location = new Point(285, 89);
			focusLabel8.Name = "focusLabel8";
			focusLabel8.Size = new Size(35, 15);
			focusLabel8.Text = "Layer";
			...
			focusLabel9.FocusControl = RotationTextBox;
			focusLabel9.Location = new Point(183, 90);
			focusLabel9.Name = "focusLabel9";
			focusLabel9.Size = new Size(49, 15);
			focusLabel9.Text = "Rotation";
			...
			focusLabel10.FocusControl = ClippingStyleComboBox;
			focusLabel10.Location = new Point(157, 114);
			focusLabel10.Name = "focusLabel10";
			focusLabel10.Size = new Size(75, 15);
			focusLabel10.Text = "Clipping Style";
			...
			base.Controls.Add(Point2GroupBox);
			...
			Point2GroupBox.ResumeLayout(false);
