...
namespace Iocomp.Design
{
	...
	public class PlotChannelBiFillEditorPlugIn : PlugInStandard
	{
		...
		public PlotChannelBiFillEditorPlugIn()
		{
			InitializeComponent();
		}
		...
		private void InitializeComponent()
		{
			...
			ColorPicker.Size = new Size(48, 20);
			...
			base.Name = "PlotChannelBiFillEditorPlugIn";
		...
		{
			base.AddSubPlugIn(new PlotChannelBiFillDataPointsEditorPlugIn(), "Data-Points", false);
			base.AddSubPlugIn(new PlotChannelBiFillSpecificEditorPlugIn(), "Bi-Fill", false);
			base.AddSubPlugIn(new PlotFillEditorPlugIn(), "FillHigh", false);
			base.AddSubPlugIn(new PlotFillEditorPlugIn(), "FillLow", false);
		...
		public override void SetSubPlugInsValue()
		{
			...
			base.SubPlugIns[2].Value = (base.Value as PlotChannelBiFill).FillHigh;
			base.SubPlugIns[3].Value = (base.Value as PlotChannelBiFill).FillLow;
			base.SubPlugIns[4].Value = (base.Value as PlotChannelBiFill).Markers;
		}
	}
}
