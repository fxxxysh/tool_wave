...
namespace Iocomp.Design
{
	...
	public class PlotChannelDigitalEditorPlugIn : PlugInStandard
	{
		...
		private void InitializeComponent()
		{
			...
			VisibleInLegendCheckBox.TabIndex = 15;
			...
			SendXAxisTrackingDataCheckBox.Size = new Size(160, 24);
			...
			SendYAxisTrackingDataCheckBox.Size = new Size(160, 24);
			...
			focusLabel8.FocusControl = LegendNameTextBox;
			focusLabel8.Location = new Point(20, 194);
			focusLabel8.Name = "focusLabel8";
			focusLabel8.Size = new Size(76, 15);
			focusLabel8.Text = "Legend Name";
			...
			ContextMenuEnabledCheckBox.TabIndex = 16;
			...
			UserCanEditCheckBox.TabIndex = 14;
			...
			focusLabel10.FocusControl = RingBufferCountEditBox;
			focusLabel10.Location = new Point(1, 78);
			focusLabel10.Name = "focusLabel10";
			focusLabel10.Size = new Size(95, 15);
			focusLabel10.Text = "Ring Buffer Count";
			...
			focusLabel6.FocusControl = OPCXValueSourceComboBox;
			focusLabel6.Location = new Point(258, 102);
			focusLabel6.Name = "focusLabel6";
			focusLabel6.Size = new Size(110, 15);
			focusLabel6.Text = "OPC X-Value Source";
		...
		{
			base.AddSubPlugIn(new PlotChannelDigitalDataPointsEditorPlugIn(), "Data-Points", false);
			base.AddSubPlugIn(new PlotChannelDigitalSpecificEditorPlugIn(), "Digital", false);
			base.AddSubPlugIn(new PlotPenEditorPlugIn(), "Trace", false);
			base.AddSubPlugIn(new PlotMarkerEditorPlugIn(), "Markers", false);
			base.AddSubPlugIn(new PlotBrushEditorPlugIn(), "Fill", false);
		}
