...
namespace Iocomp.Design
{
	...
	[ToolboxItem(false)]
	public class PlotChannelRationalEditorPlugIn : PlugInStandard
	{
		...
		public PlotChannelRationalEditorPlugIn()
		{
			InitializeComponent();
		}
		...
		private void InitializeComponent()
		{
			...
			base.Name = "PlotChannelRationalEditorPlugIn";
		...
		{
			base.AddSubPlugIn(new PlotChannelRationalDataPointsEditorPlugIn(), "Data-Points", false);
		...
		public override void SetSubPlugInsValue()
		{
			...
			base.SubPlugIns[1].Value = (base.Value as PlotChannelRational).Trace;
			base.SubPlugIns[2].Value = (base.Value as PlotChannelRational).Fill;
			base.SubPlugIns[3].Value = (base.Value as PlotChannelRational).Markers;
		}
	}
}
