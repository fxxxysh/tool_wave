...
namespace Iocomp.Design
{
	...
	public class PlotChannelBubbleEditorPlugIn : PlugInStandard
	{
		...
		public PlotChannelBubbleEditorPlugIn()
		{
			InitializeComponent();
		}
		...
		private void InitializeComponent()
		{
			...
			base.Name = "PlotChannelBubbleEditorPlugIn";
			base.Size = new Size(632, 272);
		...
		{
			base.AddSubPlugIn(new PlotChannelBubbleSpecificEditorPlugIn(), "Bubble", false);
		...
		public override void SetSubPlugInsValue()
		{
			...
			base.SubPlugIns[1].Value = (base.Value as PlotChannelBubble).Fill;
		}
	}
}
