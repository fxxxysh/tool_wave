...
namespace Iocomp.Design
{
	...
	public class PlotChannelFillEditorPlugIn : PlugInStandard
	{
		...
		private void InitializeComponent()
		{
			...
			focusLabel7.FocusControl = LegendNameTextBox;
			focusLabel7.Location = new Point(20, 194);
			focusLabel7.Name = "focusLabel7";
			focusLabel7.Size = new Size(76, 15);
			focusLabel7.Text = "Legend Name";
			...
			focusLabel6.FocusControl = ClippingStyleComboBox;
			focusLabel6.Location = new Point(253, 226);
			focusLabel6.Name = "focusLabel6";
			focusLabel6.Size = new Size(75, 15);
			focusLabel6.Text = "Clipping Style";
			...
			base.Name = "PlotChannelFillEditorPlugIn";
			base.Size = new Size(576, 280);
		...
		{
			base.AddSubPlugIn(new PlotChannelFillDataPointsEditorPlugIn(), "Data-Points", false);
