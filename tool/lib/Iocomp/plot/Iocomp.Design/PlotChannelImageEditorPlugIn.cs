...
namespace Iocomp.Design
{
	...
	public class PlotChannelImageEditorPlugIn : PlugInStandard
	{
		...
		public PlotChannelImageEditorPlugIn()
		{
			InitializeComponent();
		}
		...
		private void InitializeComponent()
		{
			...
			VisibleInLegendCheckBox.TabIndex = 14;
			...
			CapacityTextBox.Location = new Point(96, 80);
			...
			focusLabel3.Location = new Point(46, 82);
			...
			SendXAxisTrackingDataCheckBox.TabIndex = 4;
			...
			SendYAxisTrackingDataCheckBox.TabIndex = 6;
			...
			ClippingStyleComboBox.TabIndex = 10;
			...
			base.Name = "PlotChannelImageEditorPlugIn";
		...
		{
			base.AddSubPlugIn(new PlotChannelImageSpecificEditorPlugIn(), "Image", false);
			base.AddSubPlugIn(new PlotColorLookupGradientEditorPlugIn(), "Intensity Gradient", false);
		}

		public override void SetSubPlugInsValue()
		{
			base.SubPlugIns[0].Value = base.Value;
			base.SubPlugIns[1].Value = (base.Value as PlotChannelImage).IntensityGradient;
		}
	}
}
