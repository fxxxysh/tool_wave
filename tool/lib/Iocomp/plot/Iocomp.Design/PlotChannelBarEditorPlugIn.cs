...
namespace Iocomp.Design
{
	...
	public class PlotChannelBarEditorPlugIn : PlugInStandard
	{
		...
		public PlotChannelBarEditorPlugIn()
		{
			InitializeComponent();
		}
		...
		private void InitializeComponent()
		{
			...
			OPCXValueSourceComboBox.TabIndex = 29;
			...
			base.Name = "PlotChannelBarEditorPlugIn";
		...
		{
			base.AddSubPlugIn(new PlotChannelBarDataPointsEditorPlugIn(), "Data-Points", false);
			base.AddSubPlugIn(new PlotChannelBarSpecificEditorPlugIn(), "Bar", false);
		...
		public override void SetSubPlugInsValue()
		{
			...
			base.SubPlugIns[2].Value = (base.Value as PlotChannelBar).Fill;
		}
	}
}
