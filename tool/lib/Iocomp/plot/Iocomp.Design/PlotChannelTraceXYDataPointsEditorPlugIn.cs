...
namespace Iocomp.Design
{
	...
	public class PlotChannelTraceXYDataPointsEditorPlugIn : PlugInStandard
	{
		...
		private void InitializeComponent()
		{
			...
			base.Name = "PlotChannelTraceXYDataPointsEditorPlugIn";
